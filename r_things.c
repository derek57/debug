...
#include "../v_patch.h" // [crispy] colored blood sprites
...
/*
            vissprite_ptrs =
                    (vissprite_t **)malloc((num_vissprite_ptrs = num_vissprite_alloc[0] * 2)
...
//        msort(vissprite_ptrs, vissprite_ptrs /*+ num_vissprite[VST_THING]*/, num_vissprite[0]);
    }
}
